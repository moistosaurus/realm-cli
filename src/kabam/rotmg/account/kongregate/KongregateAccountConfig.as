package kabam.rotmg.account.kongregate
{
   ...
   import kabam.rotmg.account.core.view.LinkWebAccountMediator;
   ...
   import kabam.rotmg.account.kongregate.commands.KongregateLinkAccountsCommand;
   ...
   import kabam.rotmg.account.kongregate.services.KongregateLinkAccountsTask;
   ...
   public class KongregateAccountConfig implements IConfig
   {
      ...
      protected function mapCommands() : void
      {
         ...
         this.commandMap.map(LinkWebAccountSignal).toCommand(KongregateLinkAccountsCommand);
      ...
      protected function mapMediators() : void
      {
         ...
         this.mediatorMap.map(LinkWebAccountDialog).toMediator(LinkWebAccountMediator);
      }
      
      protected function mapServices() : void
      {
         this.injector.map(KongregateApi).toSingleton(LiveKongregateApi);
         this.injector.map(LinkAccountsTask).toType(KongregateLinkAccountsTask);
