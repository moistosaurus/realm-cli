package kabam.rotmg.account.kongregate.view
{
   ...
   public class KongregateAccountDetailDialog extends Sprite
   {
      ...
      public function setInfo(kongregateUserName:String, rotmgUserName:String, areLinked:Boolean) : void
      {
         ...
         this.loginText_.text = "Kongregate user:";
         ...
         this.usernameText_.text = kongregateUserName;
         ...
         {
            this.register_ = new ClickableText(12,false,"Register this account as a web account");
