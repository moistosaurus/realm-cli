package kabam.rotmg.account.steam
{
   ...
   import kabam.rotmg.account.steam.commands.SteamLinkAccountsCommand;
   ...
   import kabam.rotmg.account.steam.services.SteamLinkAccountsTask;
   ...
   public class SteamAccountConfig implements IConfig
   {
      ...
      protected function mapCommands() : void
      {
         ...
         this.commandMap.map(LinkWebAccountSignal).toCommand(SteamLinkAccountsCommand);
      }
      ...
      protected function mapServices() : void
      {
         ...
         this.injector.map(LinkAccountsTask).toType(SteamLinkAccountsTask);
