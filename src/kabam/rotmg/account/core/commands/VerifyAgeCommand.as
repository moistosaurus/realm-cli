package kabam.rotmg.account.core.commands
{
   ...
   public class VerifyAgeCommand
   {
      ...
      {
         var branching:BranchingTask = new BranchingTask(this.task);
         branching.addSuccessTask(this.makeSuccessTask());
         branching.addFailureTask(this.makeFailureTask());
         this.monitor.add(branching);
         branching.start();
      }
