...
import kabam.rotmg.ui.view.NotEnoughGoldDialog;
   ...
   public class GameServerConnection
   {
      ...
      private function encryptConnection() : void
      {
         ...
         {
            outgoing = Crypto.getCipher("rc4",MoreStringUtil.hexStringToByteArray(Parameters.RANDOM1));
            incoming = Crypto.getCipher("rc4",MoreStringUtil.hexStringToByteArray(Parameters.RANDOM2));
      ...
      public function setCondition(conditionEffect:uint, conditionDuration:Number) : void
      {
      ...
      private function onUpdate(update:Update) : void
      {
         ...
         {
            this.gs_.map.removeObj(update.drops_[i]);
         }
      }
